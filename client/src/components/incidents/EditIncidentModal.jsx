    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Edit Incident Hazard Report">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            {formData.imageUrl && (
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-2.5 bg-rose-50 hover:bg-rose-100 border border-rose-200 text-rose-600 rounded-2xl text-xs font-extrabold transition-all"
              >
          ...
          {formData.imageUrl && (
            <div className="rounded-2xl overflow-hidden max-h-40 border border-[#E0D5DC] mt-2 relative p-1 bg-[#F9F8FA]">
              <img src={formData.imageUrl} alt="Incident Edit Preview" className="w-full max-h-40 object-contain rounded-xl" />
            </div>
          )}
        </div>

        <Button type="submit" loading={loading} className="w-full py-3 mt-2 font-extrabold">
