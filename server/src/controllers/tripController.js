...
=======
    const bodyLat = req.body && (typeof req.body.latitude === 'number' ? req.body.latitude : typeof req.body.lat === 'number' ? req.body.lat : null);
    const bodyLng = req.body && (typeof req.body.longitude === 'number' ? req.body.longitude : typeof req.body.lng === 'number' ? req.body.lng : null);

    const actualLat = bodyLat !== null ? bodyLat : (trip.startCoords && typeof trip.startCoords.lat === 'number') ? trip.startCoords.lat : 23.7808875;
    const actualLng = bodyLng !== null ? bodyLng : (trip.startCoords && typeof trip.startCoords.lng === 'number') ? trip.startCoords.lng : 90.4068305;
