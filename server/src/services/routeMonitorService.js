...
// *** QA-TEST-MODE: temporarily shrunk for a real-time QA pass. MUST be restored before
// *** merging - see PATHPROHORI_QA_REPORT for the original production values. ***
const MONITOR_INTERVAL_MS = 3 * 1000; // PROD: 15 * 1000
const DEVIATION_THRESHOLD_METERS = 150;
const DEVIATION_GRACE_PERIOD_MS = 9 * 1000; // PROD: 30 * 1000
const STOP_RADIUS_METERS = 20;
const STOP_THRESHOLD_MS = 15 * 1000; // PROD: 5 * 60 * 1000
const SAFETY_CHECK_WINDOW_MS = 12 * 1000; // PROD: 2 * 60 * 1000
...
const STALE_GPS_THRESHOLD_MS = 10 * 1000; // PROD: 90 * 1000
